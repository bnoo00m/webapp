...
export const Item = (
    ...
    return (
        <div
            ...
            className={cn("group min-h-[27px] text-sm py-2 pr-3 w-full hover:bg-primary/5 flex items-center rounded-md text-muted-foreground font-medium",active && "bg-primary/5")}
        >
            {!!id && (
                <div role="button"
